  ...
  return (
    <div className='container w-full'>
      ...
      <div className="flex mt-24 ml-20 gap-20">
        <div className="w-[600px] p-6 rounded-lg border-2 border-gray-300 flex flex-col ml-44">
      ...
      <div className="w-2/3 p-10 mt-20 items-center ml-80 mr-auto mb-56 rounded-lg " style={{ backgroundImage: `url(${background})` }}>
