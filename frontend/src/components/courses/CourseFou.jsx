...
function CourseFou() {
  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-8" data-aos="fade-down" data-aos-offset="400">
        <h1 className="text-4xl font-bold text-blue-600">Nhập môn IT </h1>
        <p className="text-lg text-gray-600">Khóa học này giới thiệu những khái niệm cơ bản về phần cứng, phần mềm, mạng máy tính, lập trình, và các công nghệ khác trong lĩnh vực IT.</p>
      </div>
