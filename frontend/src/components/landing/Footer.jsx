  ...
  return (
    <footer className="pt-[142px] pb-[60px]">
      <div className="container mx-auto">
        <div
          className="flex flex-col items-center text-center lg:flex-row lg:items-start 
          lg:text-left lg:justify-between gap-y-8"
        >
          {/* Logo */}
          ...
          <div data-aos="fade-up" data-aos-offset="200" data-aos-delay="900">
            ...
            <form className="max-w-[349px] mb-[10px]">
              <div
                className="h-[62px] p-[7px] flex items-center border border-dark rounded-lg"
              >
                <input
